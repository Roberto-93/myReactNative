...
type DataListScreenProps = {
  navigation: StackNavigationProp<RouteParamList, 'DataList'>;
};

const DataListScreen: React.FC<DataListScreenProps> = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${url}/v1/Games`);
